      ...
      targets: [
        {
          ...
          dest: path.resolve(__dirname, `./public/plugins/${pluginName}/assets/`),
        },
        {
          src: path.resolve(
            __dirname,
          ...
          dest: path.resolve(__dirname, `./public/plugins/${pluginName}/docs/`),
        },
        {
          src: path.resolve(
            __dirname,
          ...
          dest: path.resolve(__dirname, `./public/plugins/${pluginName}/`),
        },
      ].map((item) => ({
        // For windows
