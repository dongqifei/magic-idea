...
import { CompoundMenuNode, MenuNode, MenuPath, Submenu, MenuModelRegistry } from '../common/menu';
...
export declare class DynamicMenuWidget extends MenuWidget {
     ...
     */
    protected previousFocusedElement: HTMLElement | undefined;
    constructor(effectiveMenuPath: MenuPath, menu: CompoundMenuNode, options: BrowserMenuOptions, contextMatcher: ContextMatcher, services: MenuServices, args?: unknown[]);
