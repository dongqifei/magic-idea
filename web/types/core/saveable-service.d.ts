...
import { Disposable, Emitter, IEvent as Event } from "./common";
import { Navigatable } from "./navigatable-types";
import { AutoSaveMode, Saveable, SaveableSource, SaveableWidget, SaveOptions, PostCreationSaveableWidget, SaveConfirmResult } from "./saveable";
...
export declare class SaveableService implements FrontendApplicationContribution {
    ...
    protected shouldSaveWidget(widget: PostCreationSaveableWidget, options?: SaveableWidget.CloseOptions): Promise<SaveConfirmResult>;
