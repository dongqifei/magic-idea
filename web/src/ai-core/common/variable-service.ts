...
import { ContributionProvider, Disposable, Emitter, MaybePromise, Prioritizeable, Event } from '@MagicIdea/core/common';
...
export class DefaultAIVariableService implements AIVariableService {
    protected logger = getLogger('DefaultAIVariableService');
