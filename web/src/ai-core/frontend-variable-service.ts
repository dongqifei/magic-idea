...
import { Disposable, Prioritizeable } from '@MagicIdea/core/common';
import { NotificationService } from '@MagicIdea/core/notification';
import { FrontendApplicationContribution, OpenerService, open } from '@MagicIdea/core';
...
export class DefaultFrontendVariableService extends DefaultAIVariableService implements FrontendApplicationContribution, FrontendVariableService {
    ...
    @inject(NotificationService) protected readonly messageService: NotificationService;
