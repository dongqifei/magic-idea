 ...
 *
 * ```ts
 * import { MenuContribution, MenuModelRegistry, MAIN_MENU_BAR } from '@MagicIdea/core/common/menu';
 *
 * @injectable()
...
export class MenuModelRegistry {
    ...
    unregisterMenuAction(itemOrCommandOrId: MenuAction | string, menuPath: MenuPath = []): void {
