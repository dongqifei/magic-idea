...
export class ToolbarActionWrapper extends AbstractToolbarMenuWrapper implements TabBarToolbarItem {
    ...
    override isEnabled(widget?: Widget): boolean {
        return this.toolbarItem.command ? this.commandRegistry.isEnabled(this.toolbarItem.command) : !!this.toolbarItem.menuPath;
    }
    ...
    protected executeCommand(widget: Widget, e: React.MouseEvent<HTMLElement>): void {
        ...
        if (this.toolbarItem.command) {
            this.commandRegistry.execute(this.toolbarItem.command);
        }
    };
    ...
    get icon(): string | undefined {
        ...
        if (this.toolbarItem.command) {
            const iconClass = this.commandRegistry.iconClass(this.toolbarItem.command);
            return iconClass;
        }
        return undefined;
    }
