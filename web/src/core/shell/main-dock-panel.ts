...
export const MAIN_AREA_ID = 'editor-dock-panel';
 ...
 */
export class MainDockPanel extends DockPanel {
    ...
    constructor(options?: DockPanel.IOptions,
        ...
        super(options);
        this.addClass(MAIN_AREA_ID);
        this.disableDND = MainDockPanel.isMainDockPanelIOptions(options) && options.disableDragAndDrop;
        ...
        this['_onTabCloseRequested'] = (sender: TabBar<Widget>, args: TabBar.ITabCloseRequestedArgs<Widget>) => {
            if (MainDockPanel.isMainDockPanelIOptions(options) && options.closeHandler !== undefined) {
    ...
    override addWidget(widget: Widget, options?: MainDockPanel.AddOptions): void {
...
export namespace MainDockPanel {
    ...
    export function isMainDockPanelIOptions(options: DockPanel.IOptions | undefined): options is IOptions {
