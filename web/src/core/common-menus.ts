...
export namespace CommonMenus {
    ...
    export const VIEW_LEFT = [...VIEW, '2_left'];
    export const VIEW_RIGHT = [...VIEW, '3_right'];
    export const VIEW_BOTTOM = [...VIEW, '4_bottom'];
    ...
    // 首选项
    export const PREFERENCES = [...MAIN_MENU_BAR, '8_preferences'];

    // last menu item
    export const HELP = [...MAIN_MENU_BAR, '9_help'];
    export const HELP_UPDATE = [...HELP, '7_update'];
    export const HELP_DEVTOOLS = [...HELP, '8_devtools'];
    export const HELP_ABOUT = [...HELP, '9_about'];
}