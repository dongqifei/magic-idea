...
export class LocalStorageService implements StorageService {
  ...
  private readonly logger = getLogger('LocalStorageService');
  ...
  private async showDiskQuotaExceededMessage(): Promise<void> {
    ...
    const ERROR_MESSAGE = `Your preferred browser's local storage is almost full.
        ...
        You can refer to MagicIDEA's documentation page for instructions on how to manually clean
        your browser's local storage or choose to clear all.`;
    console.warn(ERROR_MESSAGE, READ_INSTRUCTIONS_ACTION, CLEAR_STORAGE_ACTION);
    this.clearStorage();
  }
