...
import { MaybePromise, Emitter, IEvent as Event } from './common';
...
export interface WidgetOpenerOptions extends OpenerOptions {
     ...
     */
    widgetOptions?: ApplicationShellLayout.WidgetOptions;
}
...
export abstract class WidgetOpenHandler<W extends BaseWidget> implements OpenHandler {
     ...
     */
    async closeAll(options?: ApplicationShellLayout.CloseOptions): Promise<W[]> {
