...
import { RemoteConnectionProvider, ServiceConnectionProvider } from "@MagicIdea/core/browser/messaging/service-connection-provider";
import { COPILOT_AUTH_SERVICE_PATH, CopilotAuthState, CopilotAuthService, CopilotAuthServiceClient } from './common/copilot-auth-service';

import {
    CopilotLanguageModelsManager,
    COPILOT_LANGUAGE_MODELS_MANAGER_PATH
} from './common/copilot-language-models-manager';
...
export const bindGitHubCopilotModule = (bind: interfaces.Bind) => {
