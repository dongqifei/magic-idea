...
import { ContributionProvider, Disposable, DisposableCollection, Emitter, Event } from '@MagicIdea/core';
import {
    AIVariable,
    CapabilityType,
...
import { ChatAgentService } from '@MagicIdea/ai-chat/common';
import debounce  from 'lodash.debounce';

// Re-export types from ai-core for backward compatibility
export { GenericCapabilitiesContribution };
