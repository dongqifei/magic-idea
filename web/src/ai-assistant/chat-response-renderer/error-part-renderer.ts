...
import { ChatResponseContent, ErrorChatResponseContent } from '@MagicIdea/ai-chat/common';
...
export class ErrorPartRenderer implements ChatResponsePartRenderer<ErrorChatResponseContent> {
    ...
    render(response: ErrorChatResponseContent): ReactNode {
        ...
        return createElement('div', { className: 'theia-ChatPart-Error' },
            createElement('span', { className: 'codicon codicon-error' }),
            createElement('span', {}, response.error.message));
    }
