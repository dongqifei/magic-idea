...
import { BasePromptFragment } from '@MagicIdea/ai-core/common';
import { CHANGE_SET_SUMMARY_VARIABLE_ID } from '@MagicIdea/ai-chat/common';
import {
...
{{capability:magicscript-language default on}}
