...
import { assertChatContext } from '@MagicIdea/ai-chat/common';
...
import { FILE_VARIABLE } from '@MagicIdea/ai-core/file-variable-contribution';
import { ContextFileValidationService, FileValidationState } from '@MagicIdea/ai-chat/context-file-validation-service';
