...
export abstract class AIListDetailConfigurationWidget<T> extends AIConfigurationBaseWidget {
    ...
    protected renderContent(): React.ReactNode {
        return React.createElement(
            'div',
            { className: 'ai-list-detail-configuration-main' },
            this.renderList(),
            this.renderDetail()
        );
    }
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                this.items.map(item => {
                    ...
                    const className = `theia-TreeNode theia-CompositeTreeNode${isSelected ? ' theia-mod-selected' : ''} ${this.getItemClassName(item)}`;
                    ...
                    return React.createElement(
                        ...
                        React.createElement(
                            'span',
                            { className: 'ai-configuration-list-item-label' },
    ...
    protected renderDetail(): React.ReactNode {
        ...
        if (this.selectedItem) {
            detailContent = this.renderItemDetail(this.selectedItem);
        } else {
            detailContent = React.createElement(
                'div',
                { className: 'ai-configuration-empty-state' },
                React.createElement(
                    'span',
                    { className: 'ai-empty-state-message' },
        ...
        return React.createElement(
            'div',
            { className: 'ai-configuration-detail preferences-editor-widget' },
            detailContent
        );
    }
}