...
import { FrontendApplicationContribution, PreferenceContribution } from '@MagicIdea/core';
import { RemoteConnectionProvider, ServiceConnectionProvider } from '@MagicIdea/core/browser/messaging';
import {
    MCPFrontendService,
    MCPServerManager,
...
import { GenericCapabilitiesContribution } from '@MagicIdea/ai-core';
...
export const bindMcpServerModule = (bind: interfaces.Bind) => {
