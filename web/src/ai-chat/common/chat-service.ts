...
import { AIVariableResolutionRequest, AIVariableService, ResolvedAIContextVariable, ToolInvocationRegistry, ToolRequest } from '@MagicIdea/ai-core';
import { Emitter, Event, URI, generateUuid, Deferred } from '@MagicIdea/core/common';
...
export class ChatServiceImpl implements ChatService {
    ...
    protected logger = getLogger('ChatService');
