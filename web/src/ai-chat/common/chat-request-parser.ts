...
import { AIVariable, AIVariableService, createAIResolveVariableCache, getAllResolvedAIVariables, ToolInvocationRegistry, ToolRequest } from '@MagicIdea/ai-core';
...
export class ChatRequestParserImpl implements ChatRequestParser {
    ...
    private readonly logger = getLogger(ChatRequestParserImpl.name);
