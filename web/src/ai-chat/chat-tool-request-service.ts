...
import { ToolInvocationContext, ToolRequest } from '@MagicIdea/ai-core';
...
import { ToolConfirmationMode, TOOL_CONFIRMATION_TIMEOUT_PREFERENCE } from './common/chat-tool-preferences';
...
export class FrontendChatToolRequestService extends ChatToolRequestService {
    ...
    protected readonly logger = getLogger('ChatToolRequestService');
                    ...
                    default: {
                        ...
                        if (autoAction?.action === 'allow') {
                            ...
                            const timeoutSeconds = sessionTimeout !== undefined && sessionTimeout > 0
                                ? sessionTimeout
                                : this.preferences.get<number>(TOOL_CONFIRMATION_TIMEOUT_PREFERENCE);
