...
import { ConnectionHandler, RpcConnectionHandler, bindRootContributionProvider } from '../core/common';
...
import { BackendApplicationContribution } from '../core/backend-application';
import { connectionCloseServicePath } from '../core/common/messaging/connection-management';
...
export function bindMessagingBackendModule(bind: interfaces.Bind): void {
