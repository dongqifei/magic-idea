definePlugin('@plugins/cn.magic-idea.code-formatter', ['exports', '@capital/shared/monaco-editor'], (function (exports, monaco) { 'use strict';
  ...
  function Output$1(options, baseIndentString) {
  ...
  Output$1.prototype.__add_outputline = function() {
    this.previous_line = this.current_line;
    this.current_line = this.next_line.clone_empty();
    this.__lines.push(this.current_line);
  };
  Output$1.prototype.get_line_number = function() {
    return this.__lines.length;
  };
  Output$1.prototype.get_indent_string = function(indent, column) {
    return this.__indent_cache.get_indent_string(indent, column);
  };
  Output$1.prototype.get_indent_size = function(indent, column) {
    return this.__indent_cache.get_indent_size(indent, column);
  };
  Output$1.prototype.is_empty = function() {
    return !this.previous_line && this.current_line.is_empty();
  };
  Output$1.prototype.add_new_line = function(force_newline) {
  ...
  Output$1.prototype.get_code = function(eol) {
    this.trim(true);
  ...
  Output$1.prototype.set_wrap_point = function() {
    this.current_line._set_wrap_point();
  };
  Output$1.prototype.set_indent = function(indent, alignment) {
    indent = indent || 0;
  ...
  Output$1.prototype.add_raw_token = function(token) {
  ...
  Output$1.prototype.add_token = function(printable_token) {
  ...
  Output$1.prototype.__add_space_before_token = function() {
  ...
  Output$1.prototype.remove_indent = function(index) {
  ...
  Output$1.prototype.trim = function(eat_newlines) {
  ...
  Output$1.prototype.just_added_newline = function() {
    return this.current_line.is_empty();
  };
  Output$1.prototype.just_added_blankline = function() {
    return this.is_empty() || this.current_line.is_empty() && this.previous_line.is_empty();
  };
  Output$1.prototype.ensure_empty_line_above = function(starts_with, ends_with) {
  ...
  function Options$2(options, merge_child_field) {
  ...
  Options$2.prototype._get_array = function(name, default_value) {
  ...
  Options$2.prototype._get_boolean = function(name, default_value) {
    var option_value = this.raw_options[name];
    var result = option_value === void 0 ? !!default_value : !!option_value;
    return result;
  };
  Options$2.prototype._get_characters = function(name, default_value) {
    var option_value = this.raw_options[name];
    var result = default_value || "";
  ...
  Options$2.prototype._get_number = function(name, default_value) {
    var option_value = this.raw_options[name];
  ...
  Options$2.prototype._get_selection = function(name, selection_list, default_value) {
  ...
  Options$2.prototype._get_selection_list = function(name, selection_list, default_value) {
  ...
  Options$2.prototype._is_valid_selection = function(result, selection_list) {
  ...
  options.normalizeOpts = _normalizeOpts;
  options.mergeOpts = _mergeOpts;
  ...
  function InputScanner$2(input_string) {
    this.__input = input_string || "";
    this.__input_length = this.__input.length;
    this.__position = 0;
  }
  InputScanner$2.prototype.restart = function() {
    this.__position = 0;
  };
  InputScanner$2.prototype.back = function() {
    if (this.__position > 0) {
      this.__position -= 1;
    }
  };
  InputScanner$2.prototype.hasNext = function() {
    return this.__position < this.__input_length;
  };
  InputScanner$2.prototype.next = function() {
    var val = null;
    if (this.hasNext()) {
  ...
  InputScanner$2.prototype.peek = function(index) {
    var val = null;
    index = index || 0;
  ...
  InputScanner$2.prototype.__match = function(pattern, index) {
    pattern.lastIndex = index;
    var pattern_match = pattern.exec(this.__input);
    if (pattern_match && !(regexp_has_sticky )) {
  ...
  InputScanner$2.prototype.test = function(pattern, index) {
    index = index || 0;
    index += this.__position;
    if (index >= 0 && index < this.__input_length) {
  ...
  InputScanner$2.prototype.testChar = function(pattern, index) {
    var val = this.peek(index);
    pattern.lastIndex = 0;
    return val !== null && pattern.test(val);
  };
  InputScanner$2.prototype.match = function(pattern) {
  ...
  InputScanner$2.prototype.read = function(starting_pattern, until_pattern, until_after) {
    var val = "";
    var match;
    if (starting_pattern) {
  ...
  InputScanner$2.prototype.readUntil = function(pattern, until_after) {
    var val = "";
  ...
  InputScanner$2.prototype.readUntilAfter = function(pattern) {
    return this.readUntil(pattern, true);
  };
  InputScanner$2.prototype.get_regexp = function(pattern, match_from) {
    var result = null;
    var flags = "g";
  ...
  InputScanner$2.prototype.get_literal_regexp = function(literal_string) {
    return RegExp(literal_string.replace(/[-/\\^$*+?.()|[\]{}]/g, "\\$&"));
  };
  InputScanner$2.prototype.peekUntilAfter = function(pattern) {
    var start = this.__position;
    var val = this.readUntilAfter(pattern);
    this.__position = start;
    return val;
  };
  InputScanner$2.prototype.lookBack = function(testVal) {
    var start = this.__position - 1;
    return start >= testVal.length && this.__input.substring(start - testVal.length, start).toLowerCase() === testVal;
  };
  inputscanner.InputScanner = InputScanner$2;
  ...
  function Pattern$3(input_scanner, parent) {
  ...
  Pattern$3.prototype.read = function() {
  ...
  Pattern$3.prototype.read_match = function() {
    return this._input.match(this._match_pattern);
  };
  Pattern$3.prototype.until_after = function(pattern) {
  ...
  Pattern$3.prototype.until = function(pattern) {
    var result = this._create();
  ...
  Pattern$3.prototype.starting_with = function(pattern) {
    var result = this._create();
    result._starting_pattern = this._input.get_regexp(pattern, true);
    result._update();
    return result;
  };
  Pattern$3.prototype.matching = function(pattern) {
    var result = this._create();
    result._match_pattern = this._input.get_regexp(pattern, true);
    result._update();
    return result;
  };
  Pattern$3.prototype._create = function() {
    return new Pattern$3(this._input, this);
  };
  Pattern$3.prototype._update = function() {
  };
  ...
  WhitespacePattern$1.prototype = new Pattern$2();
  ...
  var Tokenizer$2 = function(input_string, options) {
  ...
  Tokenizer$2.prototype.tokenize = function() {
    this._input.restart();
    this.__tokens = new TokenStream();
    this._reset();
    var current;
    var previous = new Token$1(TOKEN$2.START, "");
    var open_token = null;
    var open_stack = [];
    var comments = new TokenStream();
    while (previous.type !== TOKEN$2.EOF) {
  ...
  Tokenizer$2.prototype._is_first_token = function() {
    return this.__tokens.isEmpty();
  };
  Tokenizer$2.prototype._reset = function() {
  };
  Tokenizer$2.prototype._get_next_token = function() {
    this._readWhitespace();
    var resulting_string = this._input.read(/.+/g);
    if (resulting_string) {
      return this._create_token(TOKEN$2.RAW, resulting_string);
    } else {
      return this._create_token(TOKEN$2.EOF, "");
    }
  };
  Tokenizer$2.prototype._is_comment = function() {
    return false;
  };
  Tokenizer$2.prototype._is_opening = function() {
    return false;
  };
  Tokenizer$2.prototype._is_closing = function() {
    return false;
  };
  Tokenizer$2.prototype._create_token = function(type, text) {
  ...
  Tokenizer$2.prototype._readWhitespace = function() {
    return this._patterns.whitespace.read();
  };
  tokenizer.Tokenizer = Tokenizer$2;
  tokenizer.TOKEN = TOKEN$2;

  var directives = {};

  function Directives$1(start_block_pattern, end_block_pattern) {
  ...
  Directives$1.prototype.get_directives = function(text) {
  ...
  Directives$1.prototype.readIgnored = function(input) {
    return input.readUntilAfter(this.__directives_end_ignore_pattern);
  };
  directives.Directives = Directives$1;
  ...
  function TemplatablePattern$1(input_scanner, parent) {
    ...
    var pattern = new Pattern$1(input_scanner);
    this.__patterns = {
  ...
  TemplatablePattern$1.prototype = new Pattern$1();
  TemplatablePattern$1.prototype._create = function() {
    return new TemplatablePattern$1(this._input, this);
  };
  TemplatablePattern$1.prototype._update = function() {
    this.__set_templated_pattern();
  };
  TemplatablePattern$1.prototype.disable = function(language) {
    var result = this._create();
    result._disabled[language] = true;
    result._update();
    return result;
  };
  TemplatablePattern$1.prototype.read_options = function(options) {
    var result = this._create();
  ...
  TemplatablePattern$1.prototype.exclude = function(language) {
    var result = this._create();
    result._excluded[language] = true;
    result._update();
    return result;
  };
  TemplatablePattern$1.prototype.read = function() {
    var result = "";
  ...
  TemplatablePattern$1.prototype.__set_templated_pattern = function() {
    var items = [];
  ...
  TemplatablePattern$1.prototype._read_template = function() {
  ...
  templatablepattern.TemplatablePattern = TemplatablePattern$1;
  ...
  Tokenizer$1.prototype._get_next_token = function(previous_token) {
    var token = null;
    this._readWhitespace();
    var c = this._input.peek();
    if (c === null) {
  ...
  Tokenizer$1.prototype._read_multi_string = function() {
    if (this._input.match(/"""/g)) {
      let result = this._input.readUntilAfter(/"""/g);
      return this._create_token(TOKEN$1.STRING, '"""' + result);
    }
    return null;
  };
  ...
  Tokenizer$1.prototype._allow_regexp_or_xml = function(previous_token) {
    return previous_token.type === TOKEN$1.RESERVED && in_array$1(previous_token.text, ["return", "case", "throw", "else", "do", "typeof", "yield"]) || previous_token.type === TOKEN$1.END_EXPR && previous_token.text === ")" && previous_token.opened.previous.type === TOKEN$1.RESERVED && in_array$1(previous_token.opened.previous.text, ["if", "while", "for"]) || in_array$1(previous_token.type, [
      TOKEN$1.COMMENT,
      TOKEN$1.START_EXPR,
      TOKEN$1.START_BLOCK,
      TOKEN$1.START,
  ...
  tokenizer$1.Tokenizer = Tokenizer$1;
  tokenizer$1.TOKEN = TOKEN$1;
  tokenizer$1.positionable_operators = positionable_operators$1.slice();
  tokenizer$1.line_starters = line_starters$1.slice();

  var Output = output.Output;
  var Token = token.Token;
  var acorn = acorn$2;
  var Options = options$1.Options;
  var Tokenizer = tokenizer$1.Tokenizer;
  var line_starters = tokenizer$1.line_starters;
  var positionable_operators = tokenizer$1.positionable_operators;
  var TOKEN = tokenizer$1.TOKEN;
  ...
  function registerMagicScriptFormatter() {
    monaco__namespace.languages.registerDocumentFormattingEditProvider("magicscript", {
      provideDocumentFormattingEdits(model) {
        try {
          const beautifier = new Beautifier_1(model.getValue());
          return [{
  ...
  exports.registerMagicScriptFormatter = registerMagicScriptFormatter;
