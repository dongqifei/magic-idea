definePlugin('@plugins/cn.magic-idea.embedded-agent', ['@capital/core/preferences', '@capital/shared/inversify', '@capital/core/plugin', '@capital/core/commands', '@capital/core/shell', '@capital/core/logger', '@capital/core/widgets'], (function (preferences, inversify, plugin, commands, shell, logger, widgets) { 'use strict';
  ...
  const AIEmbeddedAgentModule = new inversify.ContainerModule((bind) => {
  ...
  plugin.regContainerModule(AIEmbeddedAgentModule);
