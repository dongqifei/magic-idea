definePlugin('@plugins/cn.magic-idea.resource.task', ['@capital/shared/inversify', '@capital/core/plugin', '@capital/core/filesystem', '@capital/core/magic-api', '@capital/core/notification', 'react', '@capital/core/common'], (function (inversify, plugin, filesystem, magicApi, notification, React, common) { 'use strict';
  ...
  TaskPropertyProvider = __decorateClass$1([
