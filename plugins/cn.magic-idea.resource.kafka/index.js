definePlugin('@plugins/cn.magic-idea.resource.kafka', ['@capital/shared/inversify', '@capital/core/plugin', '@capital/core/filesystem', '@capital/core/magic-api', 'react'], (function (inversify, plugin, filesystem, magicApi, React) { 'use strict';
  ...
  KafkaPropertyProvider = __decorateClass$1([
